...
function determineNumbers() {
  numberQuery = prompt("Do you want to include numbers in your password? \n(Yes or No)");
...
function determineSpecial() {
  specialQuery = prompt("Do you want to include special characters in your password? \n(Yes or No)");
